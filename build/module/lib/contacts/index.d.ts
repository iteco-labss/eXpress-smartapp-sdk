 ...
 * @param messageMeta
 */
declare const sendMessage: ({ userHuid, groupChatId, messageBody, messageMeta, }: SendMessageMethodParams) => Promise<import("@expressms/smartapp-bridge/dist/types/eventEmitter").EmitterEventPayload> | undefined;
